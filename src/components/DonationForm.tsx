    ...
    return (
      <div className="text-center py-12 animate-fade-in-up">
        ...
        <p className="text-muted-foreground mb-2 max-w-md mx-auto">
          {t("confirmMsg")(amount.toLocaleString("en-IN"))}
        </p>
        <p className="text-sm text-primary/80 font-body italic mb-6">
          {t("everyZakatPurifies")}
        </p>
        {name && (
          <p className="text-sm text-muted-foreground mb-4">{t("from")} {name}</p>
        )}
        <a
  ...
  return (
    <div className="w-full max-w-lg mx-auto">
      <div className="mb-8">
        ...
        {!isValidAmount && amount > 0 && (
          <p className="text-sm text-destructive mt-2 font-body">
            {t("amountRange")(MIN_AMOUNT.toLocaleString("en-IN"), MAX_AMOUNT.toLocaleString("en-IN"))}
          </p>
        )}
      </div>
      ...
      >
        ...
        {(t("payViaUpi") as string).replace("{amount}", amount.toLocaleString("en-IN"))}
